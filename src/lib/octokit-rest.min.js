 ...
 * Released under the MIT License.
 */
var r}function o(e){var r,t;return!1!==s(e)&&("function"==typeof(r=e.constructor)&&(!1!==s(t=r.prototype)&&!1!==t.hasOwnProperty("isPrototypeOf")))}var p=t(13),a=t.n(p),u=t(14),d=t.n(u);function g(e,r){return function(e){if(Array.isArray(e))return e}(e)||function(e,r){var t=[],i=!0,n=!1,s=void 0;try{for(var o,p=e[Symbol.iterator]();!(i=(o=p.next()).done)&&(t.push(o.value),!r||t.length!==r);i=!0);}catch(e){n=!0,s=e}finally{try{i||null==p.return||p.return()}finally{if(n)throw s}}return t}(e,r)||function(){throw new TypeError("Invalid attempt to destructure non-iterable instance")}()}function c(e,r,t){if("string"==typeof r){let e=g(r.split(" "),2),i=e[0],n=e[1];t=Object.assign(n?{method:i,url:n}:{url:i},t)}else t=r||{};var i;t.headers=(i=t.headers)?Object.keys(i).reduce((e,r)=>(e[r.toLowerCase()]=i[r],e),{}):{};const s=n.a.all([e,t].filter(Boolean),{isMergeableObject:o});return e&&e.mediaType.previews.length&&(s.mediaType.previews=e.mediaType.previews.filter(e=>!s.mediaType.previews.includes(e)).concat(s.mediaType.previews)),s.mediaType.previews=s.mediaType.previews.map(e=>e.replace(/-preview/,"")),s}const l=/\{[^}]+\}/g;function m(e){return e.replace(/^\W+|\W+$/g,"").split(/,/)}function y(e,r){return Object.keys(e).filter(e=>!r.includes(e)).reduce((r,t)=>(r[t]=e[t],r),{})}function h(e){let r,t=e.method.toUpperCase(),i=e.url.replace(/:([a-z]\w+)/g,"{+$1}"),n=Object.assign({},e.headers),s=y(e,["method","baseUrl","url","headers","request","mediaType"]);const o=function(e){const r=e.match(l);return r?r.map(m).reduce((e,r)=>e.concat(r),[]):[]}(i);i=a.a.parse(i).expand(s),/^http/.test(i)||(i=e.baseUrl+i);const p=y(s,Object.keys(e).filter(e=>o.includes(e)).concat("baseUrl"));if(!/application\/octet-stream/i.test(n.accept)&&(e.mediaType.format&&(n.accept=n.accept.split(/,/).map(r=>r.replace(/application\/vnd(\.\w+)(\.v3)?(\.\w+)?(\+json)?$/,"application/vnd$1$2.".concat(e.mediaType.format))).join(",")),e.mediaType.previews.length)){const r=n.accept.match(/[\w-]+(?=-preview)/g)||[];n.accept=r.concat(e.mediaType.previews).map(r=>{const t=e.mediaType.format?".".concat(e.mediaType.format):"+json";return"application/vnd.github.".concat(r,"-preview").concat(t)}).join(",")}return["GET","HEAD"].includes(t)?i=function(e,r){const t=/\?/.test(e)?"&":"?",i=Object.keys(r);return 0===i.length?e:e+t+i.map(e=>"q"===e?"q="+r.q.split("+").map(encodeURIComponent).join("+"):"".concat(e,"=").concat(encodeURIComponent(r[e]))).join("&")}(i,p):"data"in p?r=p.data:Object.keys(p).length?r=p:n["content-length"]=0,n["content-type"]||void 0===r||(n["content-type"]="application/json; charset=utf-8"),["PATCH","PUT"].includes(t)&&void 0===r&&(r=""),Object.assign({method:t,url:i,headers:n},void 0!==r?{body:r}:null,e.request?{request:e.request}:null)}const q=function e(r,t){const i=c(r,t),n=function(e,r,t){return h(c(e,r,t))}.bind(null,i);return Object.assign(n,{DEFAULTS:i,defaults:e.bind(null,i),merge:c.bind(null,i),parse:h})}(null,{method:"GET",baseUrl:"https://api.github.com",headers:{accept:"application/vnd.github.v3+json","user-agent":"octokit-endpoint.js/".concat("0.0.0-development"," ").concat(d()())},mediaType:{format:"",previews:[]}});var _=t(10),b=t.n(_),w=t(11),f=t.n(w),v=t(0);t.d(r,"request",function(){return T});function E(e){(o(e.body)||Array.isArray(e.body))&&(e.body=JSON.stringify(e.body));let r,t,i={};return(e.request&&e.request.fetch||f.a)(e.url,Object.assign({method:e.method,body:e.body,headers:e.headers,redirect:e.redirect},e.request)).then(n=>{t=n.url,r=n.status;for(const e of n.headers)i[e[0]]=e[1];if(204===r||205===r)return;if("HEAD"===e.method){if(r<400)return;throw new v.RequestError(n.statusText,r,{headers:i,request:e})}if(304===r)throw new v.RequestError("Not modified",r,{headers:i,request:e});if(r>=400)return n.text().then(t=>{const n=new v.RequestError(t,r,{headers:i,request:e});try{Object.assign(n,JSON.parse(n.message))}catch(e){}throw n});const s=n.headers.get("content-type");return/application\/json/.test(s)?n.json():!s||/^text\/|charset=utf-8$/.test(s)?n.text():function(e){return e.arrayBuffer()}(n)}).then(e=>({status:r,url:t,headers:i,data:e})).catch(r=>{if(r instanceof v.RequestError)throw r;throw new v.RequestError(r.message,500,{headers:i,request:e})})}const T=function e(r,t){const i=r.defaults(t);return Object.assign(function(e,r){const t=i.merge(e,r);return t.request&&t.request.hook?t.request.hook(e=>E(i.parse(e)),t):E(i.parse(t))},{endpoint:i,defaults:e.bind(null,i)})}(q,{headers:{"user-agent":"octokit-request.js/".concat("0.0.0-development"," ").concat(b()())}})}]);
